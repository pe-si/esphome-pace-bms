...
protected:
	// protocol variants
	bool ProcessReadAnalogInformationResponse_PYLON(const uint8_t busId, OPTIONAL_NS::optional<uint8_t> respondingBusId, const std::vector<uint8_t>& response, AnalogInformation& analogInformation);
	bool ProcessReadAnalogInformationResponse_SEPLOS(const uint8_t busId, OPTIONAL_NS::optional<uint8_t> respondingBusId, const std::vector<uint8_t>& response, AnalogInformation& analogInformation);
	bool ProcessReadAnalogInformationResponse_EG4(const uint8_t busId, OPTIONAL_NS::optional<uint8_t> respondingBusId, const std::vector<uint8_t>& response, AnalogInformation& analogInformation);
...
protected:
	// protocol variants
	bool ProcessReadStatusInformationResponse_PYLON(const uint8_t busId, OPTIONAL_NS::optional<uint8_t> respondingBusId, const std::vector<uint8_t>& response, StatusInformation& statusInformation);
	bool ProcessReadStatusInformationResponse_SEPLOS(const uint8_t busId, OPTIONAL_NS::optional<uint8_t> respondingBusId, const std::vector<uint8_t>& response, StatusInformation& statusInformation);
	bool ProcessReadStatusInformationResponse_EG4(const uint8_t busId, OPTIONAL_NS::optional<uint8_t> respondingBusId, const std::vector<uint8_t>& response, StatusInformation& statusInformation);
